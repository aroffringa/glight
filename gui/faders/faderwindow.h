...
class FaderWindow : public Gtk::Window {
 public:
  ...
  void SetMidiController(system::MidiController *controller) {
    _connectedMidiController = controller;
  }
 ...
 private:
  ...
  Gtk::MenuItem _miAddFader, _miAdd5Faders, _miAddToggleButton,
      _miAdd5ToggleButtons, _miAddColorButton, _miAddToggleColumn,
      _miRemoveFader, _miRemove5Faders;
  ...
  system::MidiController *_connectedMidiController;
