...
public:
  ...
  theatre::Fixture *FixtureAt(double mouse_x, double mouse_y, double width, double height) const {
    return FixtureAt(MouseToPosition(mouse_x, mouse_y, width, height));
  }
  theatre::Position MouseToPosition(double mouse_x, double mouse_y, double width, double height) const;
