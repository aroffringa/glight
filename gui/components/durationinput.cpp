...
inline const double values[kNValues] = {
    0.0,    40.0,   80.0,   160.0,  300.0,   500.0,   750.0,   1000.0,  1500.0,   2000.0,  2500.0,
    3000.0, 4000.0, 5000.0, 7500.0, 10000.0, 15000.0, 30000.0, 60000.0, 120000.0, 300000.0};
}  // namespace

DurationInput::DurationInput(double value)
    : scale_(Gtk::Adjustment::create(0, 0, kNValues, 1), Gtk::Orientation::HORIZONTAL) {
  Initialize(value);
}
