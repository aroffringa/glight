...
class FlacDecoder : private FLAC::Decoder::File
{
	public:
		...
		: _isOpen(false), _filename(filename), _writePos(0), _activeWriteBuffer(0), _readPos(0), _activeReadBuffer(0), _decodeThread(), _isStopping(false), _bufferSize(1024*1024)
		{
