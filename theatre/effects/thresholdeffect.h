...
class ThresholdEffect : public Effect {
 public:
  ...
  void SetLowerStartLimit(unsigned lowerStartLimit) {
    _lowerStartLimit = lowerStartLimit;
  }
  void SetLowerEndLimit(unsigned lowerEndLimit) {
    _lowerEndLimit = lowerEndLimit;
  }
  void SetUpperStartLimit(unsigned upperStartLimit) {
    _upperStartLimit = upperStartLimit;
  }
  void SetUpperEndLimit(unsigned upperEndLimit) {
