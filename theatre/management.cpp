...
system::ObservingPtr<Chase> Management::AddChasePtr() {
  return static_cast<system::ObservingPtr<Chase>>(AddChase().GetObserver());
}
...
system::ObservingPtr<Scene> Management::AddScenePtr(bool in_folder) {
