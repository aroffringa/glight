...
public:
	CurveEffectPS()
	{
		addProperty(Property("function", "Function", std::vector<std::pair<std::string,std::string>>{
...
protected:
	virtual void setChoice(FolderObject& object, size_t index, const std::string& value) const final override
	{
	...
	virtual std::string getChoice(const FolderObject& object, size_t index) const final override
	{
		...
		switch(index) {
			case 0: switch(cfx.GetFunction())
			{
			case CurveEffect::Linear: return "linear";
			case CurveEffect::Quadratic: return "quadratic";
			case CurveEffect::Exponential: return "exponential";
			case CurveEffect::Logarithmic: return "logarithmic";
			case CurveEffect::Sinusoid: return "sinusoid";
			case CurveEffect::WarmUp: return "warmup";
			case CurveEffect::SquareRoot: return "squareroot";
			}
			break;
		}
		return 0;
