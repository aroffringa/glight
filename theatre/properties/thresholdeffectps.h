...
protected:
  virtual void setControlValue(FolderObject &object, size_t index,
    ...
    switch (index) {
    case 0:
      tfx.SetLowerStartLimit(value);
      break;
    case 1:
      tfx.SetLowerEndLimit(value);
      break;
    case 2:
      tfx.SetUpperStartLimit(value);
      break;
    case 3:
      tfx.SetUpperEndLimit(value);
      break;
    }
  }
  ...
  virtual unsigned getControlValue(const FolderObject &object,
    ...
    switch (index) {
    case 0:
      return tfx.LowerStartLimit();
    case 1:
      return tfx.LowerEndLimit();
    case 2:
      return tfx.UpperStartLimit();
    case 3:
      return tfx.UpperEndLimit();
    }
    return 0;
  }
};
