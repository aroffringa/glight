...
public:
	...
	const std::string& OptionName(size_t index) const { return _options[index].first; }
	const std::string& OptionDescription(size_t index) const { return _options[index].second; }
