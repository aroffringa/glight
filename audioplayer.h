...
class AudioPlayer : private SyncListener {
	public:
		...
		AudioPlayer(class FlacDecoder &decoder) : _alsaPeriodSize(256), _alsaBufferSize(2048), _alsaThread(), _isStopping(false), _isOpen(false), _decoder(decoder), _startPosition(0)
		{
			_syncListener = this;
		}
