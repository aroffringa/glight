...
protected:
	void setDuration(FolderObject& object, size_t index, double value) const final override
	{
		...
		switch(index) {
			case 1: pfx.SetAttack(value); break;
			case 2: pfx.SetHold(value); break;
			case 3: pfx.SetRelease(value); break;
			case 4: pfx.SetSleep(value); break;
		}
	}
	...
	double getDuration(const FolderObject& object, size_t index) const final override
	{
		...
		switch(index) {
			case 1: return pfx.Attack();
			case 2: return pfx.Hold();
			case 3: return pfx.Release();
			case 4: return pfx.Sleep();
		}
		return 0;
	}
