...
class TrackablePtr {
 public:
  ...
  constexpr explicit TrackablePtr(std::unique_ptr<T> object) noexcept : object_(object.release()) {}
  /**
  ...
  constexpr explicit operator bool() const noexcept { return static_cast<bool>(object_); }
